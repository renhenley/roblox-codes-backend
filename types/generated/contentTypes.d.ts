...
export interface ApiCodeCode extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateFound: Schema.Attribute.DateTime;
    dateVerified: Schema.Attribute.DateTime;
    ...
    verificationStatus: Schema.Attribute.Enumeration<
      ['working', 'expired', 'unverified', 'fake']
    >;
  };
}
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    robloxGameId: Schema.Attribute.String;
    robloxUrl: Schema.Attribute.String;
